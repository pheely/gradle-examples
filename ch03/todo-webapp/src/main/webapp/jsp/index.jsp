...
<html lang="en">
  ...
  <title>gradle-in-action-source/index.jsp at master · bmuschko/gradle-in-action-source</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjQ1ODM1NTM4OmRkYmFjZGRlNjQwOWM5ZDdlMTMxYWJjMzJiM2E1MjFjMDA4MzM5MjkyMGYwZDJjZTlkMTgyZWZlYWJmNTYwZGY=--c487a3d67d9e4cdfffe725e72a2f96feff2898ee">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="F2F5:30EC:51D5873:8E81817:5A77AF19" data-pjax-transient>
...
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="pheely">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta content="440872" name="octolytics-dimension-user_id" /><meta content="bmuschko" name="octolytics-dimension-user_login" /><meta content="10155417" name="octolytics-dimension-repository_id" /><meta content="bmuschko/gradle-in-action-source" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="10155417" name="octolytics-dimension-repository_network_root_id" /><meta content="bmuschko/gradle-in-action-source" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/bmuschko/gradle-in-action-source/blob/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" data-pjax-transient>
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/bmuschko/gradle-in-action-source/search" class="js-site-search-form" data-scoped-search-url="/bmuschko/gradle-in-action-source/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/bmuschko/gradle-in-action-source/blob/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      ...
      <ul class="dropdown-menu dropdown-menu-sw">
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="DYC0VuE2zkBlsvQxPoxiL/9I2/ZassqDqXLxV2VYh9zoVOR+XeBpNzI1RXAUdC8WqgoAhlKv9lSD59skTMAD2Q==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="SMOo8vPBIuZO8mJPs4aV5mAtQUF+Nu+Wq5K77pHA6RKtF/jaTxeFkRl10w6ZftjfNW+aMXYr00GBB5GduFhtFw==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Y01mrZe66Smy4kkCW4GpPImJBBLvVIViAh4Xm3kBFqY09xHmiekc7NbFkQrwFmLrp9a3Ok3DN3GaDwOswq+7DA==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="10155417" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/bmuschko/gradle-in-action-source/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="e+deYep08tLs348IjFOyFNE2/Wu5mpYbe9bfpfzMsN6D7qdSVG4p9z4DfmkiQpN9lkgGdSRC7HrL4y8rxHLGaA==" /></div>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/bmuschko/gradle-in-action-source/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="O5BfP5/XKdC1NEEGRPSvSbDSE6MX7y9yiDEX76TsXV276AqGEbdbPU4bLBJYcZrS6CZmmoaMsjYoRdZ1WTc4hw==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/bmuschko/gradle-in-action-source/fork" class="btn-with-count" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="eq9khiKs7u8pLkNTyJWVd5aZIyrizCk1RQuFRQeyneeYS/5uor5rZPHFKMEMN4e7aVIH7/3WS6PllexPeijJaw==" /></div>
            <button
                type="submit"
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a href="/bmuschko/gradle-in-action-source/blob/4b65643fd2f3dd0fe4c145fec1f9d1ea8182f319/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:20686ba51bd7ba7e54ec45d52a547363 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/bmuschko/gradle-in-action-source/blob/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/bmuschko/gradle-in-action-source/tree/book-release/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp"
  ...
  <include-fragment class="commit-tease" src="/bmuschko/gradle-in-action-source/contributors/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/bmuschko/gradle-in-action-source/raw/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/bmuschko/gradle-in-action-source/blame/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/bmuschko/gradle-in-action-source/commits/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/bmuschko/gradle-in-action-source/edit/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="o6AP8CUiNDr+uS/6jbVVknfv7VJqhtuQTReVB+hHJFFjferbkV2xihaxpYhIIN38zbCKjUn/ZgMmMHjnf0lv4g==" /></div>
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/bmuschko/gradle-in-action-source/delete/master/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="HLcOQ0E7IsDQ9UhhTpB9P3OE52WUchYB1E43oIap5O3jFfjQZCrPoAXAV+j/sN5MqMpNnD5Mve+dpeaos4exHw==" /></div>
  ...
  <div itemprop="text" class="blob-wrapper data type-java-server-pages">
      ...
      <tr>
        ...
        <td id="LC2" class="blob-code blob-code-inner js-file-line">&lt;<span class="pl-ent">c:redirect</span> <span class="pl-e">url</span>=<span class="pl-s"><span class="pl-pds">&quot;</span>/all<span class="pl-pds">&quot;</span></span>/&gt;</td>
      </tr>
</table>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/bmuschko/gradle-in-action-source/blame/4b65643fd2f3dd0fe4c145fec1f9d1ea8182f319/chapter03/todo-webapp/src/main/webapp/jsp/index.jsp" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.24990s from unicorn-3966042766-fwjj8">GitHub</span>, Inc.</li>
